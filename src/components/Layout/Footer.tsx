...
const Footer: React.FC = () => {
  ...
  return (
    <FooterContainer>
      <FooterContent>
        <FooterSection>
          ...
          <SocialLinks>
            ...
            <SocialLink href="https://www.instagram.com/ken_walk88?igsh=cmd2cnMxbzUyMWY0" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      ...
      <Copyright>
        <p>&copy; {currentYear} Walker Texas Chef. All rights reserved.</p>
      </Copyright>
    </FooterContainer>
  );
};
